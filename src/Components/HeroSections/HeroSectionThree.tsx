  ...
  const PlayAnimationText = () => {
    if (ParagraphRef.current) {
      ...
      gsap.to(ParagraphRef.current, {
        ...
        text: {
          value:
            "Sviluppo soluzioni software innovative e scalabili, utilizzando tecnologie moderne per creare applicazioni web e mobile performanti.",
          newClass: "class2",
          delimiter: "",
        },
      });
  ...
  return (
    <>
      <ContainerDiv ref={containerDivRef}>
        <ContainerImg>
          <Image src="/Layout/albero.png" />
        </ContainerImg>
        <ContainerText>
          <Title ref={TitleRef}>Di cosa mi occupo?</Title>
